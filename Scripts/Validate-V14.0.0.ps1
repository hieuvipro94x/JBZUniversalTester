...
Check 'Version 14.0.0' ($version -match '<Version>13\.0\.0</Version>')
Check 'Version tag 14_0_0' ($version -match '<VersionFileTag>14_0_0</VersionFileTag>')
...
Write-Host 'V14.0.0 static validation PASS.' -ForegroundColor Cyan
