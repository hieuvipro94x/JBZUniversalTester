...
title JBZUniversalTester V12.10.1 - FaultGrid Restore Verify
set "LOG=verify_build_V12.10.1.log"

echo ============================================================ > "%LOG%"
echo JBZUniversalTester V12.10.1 FAULTGRID RESTORE VERIFY >> "%LOG%"
...
echo [1/6] Static validation V12.10.1
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "Scripts\Validate-V12.10.1.ps1" >> "%LOG%" 2>&1
...
echo.
echo ============================================================
echo VERIFY + BUILD + PUBLISH V12.10.1 SUCCESS
echo Log: %CD%\%LOG%
echo ============================================================
pause
exit /b 0
